      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            O futuro é de quem domina a IA! Empresas buscam gestores de fluxo para automatizar processos e liderar com inteligência. Participe da mentoria gratuita no dia 13/06/2025 às 19h00 e descubra como conquistar oportunidades e se destacar no mercado. Garanta sua vaga!
          </p>
          <div className="mt-4">
            <Button
